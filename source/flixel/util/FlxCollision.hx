...
class FlxCollision
{
	 ...
	 */
	public static function createCameraWallBlock(Camera:FlxCamera, PlaceOutside:Bool = true, Thickness:Int, AdjustWorldBounds:Bool = false):FlxSpriteGroup
	{
		var left:Block = null;
		...
		if (PlaceOutside)
		{
			left = new Block(Math.floor(Camera.x - Thickness), Math.floor(Camera.y), Thickness, Camera.height);
			right = new Block(Math.floor(Camera.x + Camera.width), Math.floor(Camera.y), Thickness, Camera.height);
			top = new Block(Math.floor(Camera.x - Thickness), Math.floor(Camera.y - Thickness), Camera.width + Thickness * 2, Thickness);
			bottom = new Block(Math.floor(Camera.x - Thickness), Camera.height, Camera.width + Thickness * 2, Thickness);
		...
		{
			left = new Block(Math.floor(Camera.x), Math.floor(Camera.y + Thickness), Thickness, Camera.height - (Thickness * 2));
			right = new Block(Math.floor(Camera.x + Camera.width - Thickness), Math.floor(Camera.y + Thickness), Thickness,
				Camera.height - (Thickness * 2));
			top = new Block(Math.floor(Camera.x), Math.floor(Camera.y), Camera.width, Thickness);
			bottom = new Block(Math.floor(Camera.x), Camera.height - Thickness, Camera.width, Thickness);
